...
RUN_ENV=(
  ...
  INPUT_FILE PUBLIC_DATASET HF_WEKA_REPO CUSTOM_DATASET_TYPE TOKENIZER WEKA_NUM_DATASET_ENTRIES AIPERF_UNSAFE_OVERRIDE
  FIXED_SCHEDULE MAX_CONTEXT_LENGTH
  REMOTE_URL REMOTE_ENDPOINT REMOTE_SERVER_METRICS_URL REMOTE_GPU_TELEMETRY_URL REMOTE_SERVER_COMMAND REMOTE_API_KEY
