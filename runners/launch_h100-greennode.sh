#!/usr/bin/env bash
# Launch script for GreenNode H100 runners (plain Docker, no Slurm/enroot).
# Selected by benchmark-tmpl.yml via: bash ./runners/launch_${RUNNER_NAME%%_*}.sh
# where RUNNER_NAME like "h100-greennode_00" → this script.
...
RUN_ENV=(
  ...
  INPUT_FILE PUBLIC_DATASET CUSTOM_DATASET_TYPE
