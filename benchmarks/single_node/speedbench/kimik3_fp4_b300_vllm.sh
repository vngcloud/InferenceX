...
#   bash benchmarks/single_node/speedbench/kimik3_fp4_b300_vllm.sh
#
# Tunables (env):
...

{
    ...
    echo "# Auto-generated by benchmarks/single_node/speedbench/kimik3_fp4_b300_vllm.sh (speedbench-al.yml)."
    echo "#"
