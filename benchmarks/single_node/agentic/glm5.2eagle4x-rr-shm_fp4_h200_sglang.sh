...
# 4xH200 GLM-5.2-W4AFP8: TP=4 DP=4 EP=4, shm_peer_l2 HiCache, EAGLE, round_robin router.
# Comparison recipe: round_robin (no dp-aware/cache_aware) + shm_peer_l2, to measure
# cross-rank L2 read contribution without router-level prefix steering.
