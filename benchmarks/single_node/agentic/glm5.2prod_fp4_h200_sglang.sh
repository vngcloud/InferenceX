...
# GLM-5.2 W4AFP8 prod-replica benchmark: server args mirror the live
# glm-52-fp8-h200-8x-worker deployment 1:1 (minus --ep 8, default router).
# Runs on lmsysorg/sglang:dev which carries the W4AFP8+DeepEP fix (#33669).
