...
# GLM-5.3 W4AFP8 prod-exact DP8 benchmark, DeepEP variant of glm5.3proddp8.
# GLM-5.3 is architecturally identical to GLM-5.2, so the same serving
# configuration applies. Only the checkpoint differs (PhalaCloud/GLM-5.3-W4AFP8).
# Identical to glm5.2proddp8deep_fp4_h200_sglang.sh (--dp 8, HiCache 128GB/rank
...
#
# Model auto-resolves from HF cache: snapshot_download(PhalaCloud/GLM-5.3-W4AFP8)
