...
# Identical to glm5.2_fp4_h200_sglang.sh except for three flags the live
# glm-52-fp8-h200-8x-worker sets and sglang v0.5.18 defaults off: the two
# DP-attention sync flags below and --dsa-prefill-backend flashmla_sparse_q8.
# Everything else -- dp == tp, no --ep, mem-fraction 0.85, lpm, hicache ratio
# from the config, EAGLE 3/1/4 -- is deliberately unchanged, so the delta
# against that recipe is those three flags and nothing else.
