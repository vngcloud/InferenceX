...
# glm5.2ll5_fp4_h200_sglang.sh except EAGLE runs 7 steps / 8 draft tokens
# instead of 5 / 6, i.e. one more rung on the speculative-depth ladder that
# ran 3/4 (glm5.2dplm) -> 5/6 (glm5.2ll5) -> 7/8 here. Kept as its own file
# to get its own MODEL_PREFIX, since the conc ladder overlaps glm5.2ll5 at 4
# and 8 and agg_bmk.json tells arms apart by prefix. Driven with dp-attn
