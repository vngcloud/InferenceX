...
# 4xH200 GLM-5.2-W4AFP8: TP=4 DP=4 EP=4, local HiCache (no shm_peer_l2), EAGLE, dp-attn always on.
# Comparison recipe vs glm5.2eagle4x_fp4_h200_sglang.sh — identical except --hicache-storage-backend
# shm_peer_l2 is removed, leaving HiCache with per-rank local L2 only.
