...
# SPEED-Bench throughput_8k high-entropy split, ignore-eos on, depth 3.
#
...
# same category) for the preflight result that cleared this checkpoint to run
...
# field.
# Matrix key: gemma4sbdf2hi3-fp8block-h200-vllm, model-prefix gemma4sbdf2hi3.
#
