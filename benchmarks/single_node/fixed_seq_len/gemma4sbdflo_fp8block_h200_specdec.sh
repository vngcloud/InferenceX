...
# Gemma-4 31B FP8-block -- STAGE 5 cell: DFlash, RedHatAI/gemma-4-31B-it-speculator.dflash
# on the SPEED-Bench throughput_8k low-entropy split, ignore-eos on.
#
...
# Matrix key: gemma4sbdflo-fp8block-h200-vllm, model-prefix gemma4sbdflo.
#
